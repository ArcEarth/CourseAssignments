...
GLWindow::GLWindow(LPCSTR title, UINT width, UINT height, UINT bits, BOOL fullscreenflag)
{
}
...
BOOL GLWindow::CreateGLWindow(LPCSTR title, UINT width, UINT height, UINT bits, BOOL fullscreenflag, WNDPROC wndProc)
{
...
GLvoid GLWindow::ReSizeGLScene(GLsizei width, GLsizei height)		// Resize And Initialize The GL Window
{
